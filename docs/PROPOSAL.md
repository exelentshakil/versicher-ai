...
having built systems at Legiit ($1M ARR, 400k+ users), i own the whole loop from product spec to shipping production code and testing evals.

at $40/hr (30+ hrs/wk, cet aligned):
- week 1: spec the vertical, lock the underwriting logic, and ship the live prototype
- week 2: test edge cases against weird inputs, harden the pipeline, and roll it out

which vertical do you want to ship first (b2c quote flow or b2b legacy migration)?
